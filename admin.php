        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="our-link">
                        <ul>
                            <h2 style="color:green">ADMIN_PAGE</h2>
    ...
    <div class="container">
        <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 style="color:blue">ADMIN_PAGE</h1>
                    <p>Các chức năng giúp ADMIN quản lý</p>
                    <ul>
                        <li>
                            <a href="xemdon.php"><button style="color:purple" type="button">Xem danh sách đơn hàng </button></a>&emsp;
                            <a href="xemlienhe.php"><button style="color:green" type="button">Xem danh sách liên hệ</button></a>&emsp;
                            <a href="xemuser.php"><button style="color:blue"  type="button">Xem danh sách người dùng</button></a>&emsp;
                            <a href="addproduct.php"><button style="color:red" type="button">Thêm sản phẩm mới</button></a>&emsp;
                        </li><br>
                        <li>
                        <a href="index.php"><button style="color:blue">HOME</button></a>
                        </li>
                    </ul>
                    </div>
                </div>
