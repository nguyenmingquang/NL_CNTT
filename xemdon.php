        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="our-link">
                        <ul>
                            <h2 style="color:palevioletred">DANH SÁCH ĐƠN HÀNG</h2>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-fadeInLeft">
                        ...
                        <p>Xem chi tiết sản phẩm của đơn hàng</p>
                        <?php
                        echo "<table style='border:solid 4px black;'>";
                        echo "<tr><th>STT</th><th>Họ tên</th><th>Địa chỉ</th><th>SĐT</th><th>Tổng</th><th>Phương thức thanh toán</th><th>Thời gian</th></tr>";
                        ...
                        try {
                            ...
                            $stmt = $conn->prepare("SELECT  id, name, address, phone,total,pttt, created_at FROM bill");
                            $stmt->execute();
